...
namespace Sample {
public class SheepControlScript : MonoBehaviour
{
    ...
    private void STATUS ()
    {
        ...
        if(_Animator.GetCurrentAnimatorStateInfo(0).IsTag("Baa"))
        {
            _Status["Baa"] = true;
        }
        else if(!_Animator.GetCurrentAnimatorStateInfo(0).IsTag("Baa"))
        {
            _Status["Baa"] = false;
        }
    }
    ...
    private void EAT ()
	{
		...
		{
	    	_Animator.CrossFade("eat_shift1", 0.2f, 0, 0);
	    }
        if (_Animator.GetCurrentAnimatorStateInfo(0).normalizedTime >= 1
            && _Animator.GetCurrentAnimatorStateInfo(0).IsName("eat_shift1")
            && !_Animator.IsInTransition(0))
        {
        ...
        if (_Animator.GetCurrentAnimatorStateInfo(0).normalizedTime >= 1.5f
            ...
            && !_Animator.IsInTransition(0))
        {
            _Animator.CrossFade("eat_shift2", 0.1f, 0, 0);
        }
        if (_Animator.GetCurrentAnimatorStateInfo(0).normalizedTime >= 1
            && _Animator.GetCurrentAnimatorStateInfo(0).IsName("eat_shift2")
            && !_Animator.IsInTransition(0))
        {
            _Animator.CrossFade("idle", 0.1f, 0, 0);
        }
    ...
    private void BAA ()
	{
		...
		{
	    	_Animator.CrossFade("baa", 0.2f, 0, 0);
	    }
        if (_Animator.GetCurrentAnimatorStateInfo(0).normalizedTime >= 1
            && _Animator.GetCurrentAnimatorStateInfo(0).IsName("baa")
            && !_Animator.IsInTransition(0))
        {
            _Animator.CrossFade("idle", 0.1f, 0, 0);
        }
